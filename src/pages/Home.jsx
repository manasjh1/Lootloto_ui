...
export default function Home() {
  ...
  return <div className="storefront" id="stage">
    ...
    <main>
      <section className="hero-wrap" id="deals"><div className="hero-copy"><span className="eyebrow">Saturday special / no bargaining needed</span><h1>Small joys.<br /><em>Big jhola.</em></h1><p>Street-market energy, doorstep delivery. We already fought the shopkeeper so you can shop in peace.</p><div className="hero-buttons"><a className="button button-dark" href="#products">Shop the stalls <span>→</span></a><button className="text-button" onClick={() => notify("Prices are low. Your willpower is lower.")}>Tell me a secret <span>↗</span></button></div></div><div className="hero-art"><div className="sunburst">UP TO<br /><strong>40%</strong><br />OFF</div><div className="hero-card"><span className="tape">AUNTY APPROVED</span><div className="hero-product">JHOLA<br /><small>full of nonsense</small></div><span className="scribble">sasta, sundar,<br />slay.</span></div><span className="hero-sticker sticker-yellow">NO<br />FOMO</span><span className="hero-sticker sticker-pink">₹99<br />STARTS</span></div></section>
